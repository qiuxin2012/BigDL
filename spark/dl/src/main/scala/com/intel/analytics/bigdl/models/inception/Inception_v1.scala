...
object Inception_Layer_v1 {
  def apply(inputSize: Int, config: Table, namePrefix : String = "") : Module[Float] = {
    ...
    conv1.add(SpatialConvolution(inputSize,
      ...
      .setInitMethod(weightInitMethod = Xavier, ConstInitMethod(0.2)).setName(namePrefix + "1x1"))
    ...
    conv3.add(SpatialConvolution(inputSize,
      ...
      .setInitMethod(weightInitMethod = Xavier, ConstInitMethod(0.2))
    ...
    conv3.add(SpatialConvolution(config[Table](2)(1),
      ...
      .setInitMethod(weightInitMethod = Xavier, ConstInitMethod(0.2)).setName(namePrefix + "3x3"))
    ...
    conv5.add(SpatialConvolution(inputSize,
      ...
      .setInitMethod(weightInitMethod = Xavier, ConstInitMethod(0.2)).setName(namePrefix + "5x5_reduce"))
    ...
    conv5.add(SpatialConvolution(config[Table](3)(1),
      ...
      .setInitMethod(weightInitMethod = Xavier, ConstInitMethod(0.2)).setName(namePrefix + "5x5"))
    ...
    pool.add(SpatialConvolution(inputSize,
      ...
      .setInitMethod(weightInitMethod = Xavier, ConstInitMethod(0.2)).setName(namePrefix + "pool_proj"))
...
object Inception_v1_NoAuxClassifier {
  def apply(classNum: Int, hasDropout: Boolean = true): Module[Float] = {
    ...
    model.add(SpatialConvolution(64, 192, 3, 3, 1, 1, 1, 1)
      .setInitMethod(weightInitMethod = Xavier, ConstInitMethod(0.2)).setName("conv2/3x3"))
    ...
    model.add(Linear(1024, classNum)
      .setInitMethod(weightInitMethod = Xavier, ConstInitMethod(0.2)).setName("loss3/classifier"))
