...
- ##### Using Hugging Face `transformers` INT4 format
  ...
  Notice: For more quantized precision, you can use another parameter `load_in_low_bit`. Available stype is sym_int4, asym_int4, syn_int5, asym_int5, syn_int8.
  ```python
  model = AutoModelForCausalLM.from_pretrained('/path/to/model/', load_in_low_bit="syn_int5")
  ```
